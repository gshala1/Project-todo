...
const DeleteModal: React.FC<DeleteModalProps> = ({ open, handleClose, handleDelete }) => {
  ...
  return (
    <Dialog className='dialog-delete' open={open} onClose={handleClose}>
      <div className='all-img'>
        ...
        <Image className='img-x' onClick={handleClose} src={iconX} alt='icon-x' />
      </div>
      ...
      <DialogActions className="all-btnn">
        <Button className="btnn-cancel" onClick={handleClose} variant="outlined">
          Cancel
        </Button>
        <Button className="btnn-delete" onClick={handleConfirmDelete} variant="contained" color="error">
          Delete
        </Button>
      </DialogActions>
    </Dialog>
